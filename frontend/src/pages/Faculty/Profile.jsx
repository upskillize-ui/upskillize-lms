...
function Profile() {
  ...
  const fetchTeachingStats = async () => {
    try {
      const response = await api.get('/faculty/profile/stats');
      if (response.data.success) {
        setTeachingStats(response.data.stats || {});
      }
    } catch (error) {
        ...
        {teachingStats === null ? (
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <div className="text-center p-4 bg-blue-50 rounded-lg">
              <p className="text-3xl font-bold text-blue-600">{teachingStats.activeCourses ?? '—'}</p>
              <p className="text-sm text-gray-600 mt-1">Active Courses</p>
            </div>
            <div className="text-center p-4 bg-green-50 rounded-lg">
              <p className="text-3xl font-bold text-green-600">{teachingStats.totalStudents ?? '—'}</p>
              <p className="text-sm text-gray-600 mt-1">Total Students</p>
            </div>
            <div className="text-center p-4 bg-purple-50 rounded-lg">
              <p className="text-3xl font-bold text-purple-600">{teachingStats.batches ?? '—'}</p>
              <p className="text-sm text-gray-600 mt-1">Batches</p>
            </div>
            <div className="text-center p-4 bg-yellow-50 rounded-lg">
              <p className="text-3xl font-bold text-yellow-600">
                {professionalInfo.experience_years || teachingStats.experienceYears || '—'}
              </p>
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              {activeTab === 'personal' && (
                <div className="space-y-4">
                  ...
                  >
                    {saving ? <><Loader size={20} className="animate-spin" />Saving...</> : <><Save size={20} />Save Personal Info</>}
                  </button>
                </div>
              )}
              ...
              {activeTab === 'professional' && (
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full bg-accent hover:bg-blue-700 text-white py-3 rounded-lg font-semibold transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {saving ? <><Loader size={20} className="animate-spin" />Saving...</> : <><Save size={20} />Save Professional Info</>}
                  </button>
                </div>
              )}
              ...
              {activeTab === 'contact' && (
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full bg-accent hover:bg-blue-700 text-white py-3 rounded-lg font-semibold transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {saving ? <><Loader size={20} className="animate-spin" />Saving...</> : <><Save size={20} />Save Contact Info</>}
                  </button>
                </div>
              )}
              ...
              {activeTab === 'social' && (
                <div className="space-y-4">
                  <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">
                        <Linkedin size={16} className="inline mr-2 text-blue-600" />LinkedIn
                      </label>
                      <input
                        type="url"
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">
                        <Twitter size={16} className="inline mr-2 text-blue-400" />Twitter
                      </label>
                      <input
                        type="url"
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">
                        <Globe size={16} className="inline mr-2 text-purple-600" />Website/Portfolio
                      </label>
                      <input
                        type="url"
                  ...
                  <button
                    ...
                    className="w-full bg-accent hover:bg-blue-700 text-white py-3 rounded-lg font-semibold transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {saving ? <><Loader size={20} className="animate-spin" />Saving...</> : <><Save size={20} />Save Social Links</>}
                  </button>
                </div>
              )}
              ...
              {activeTab === 'password' && (
                <div className="space-y-4 max-w-2xl">
                  ...
                  <button
                    ...
                    className="w-full bg-accent hover:bg-blue-700 text-white py-3 rounded-lg font-semibold transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {saving ? <><Loader size={20} className="animate-spin" />Changing Password...</> : <><Lock size={20} />Change Password</>}
                  </button>
                </div>
              )}
            </div>
